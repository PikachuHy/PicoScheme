...
SymenvPtr add_environment_defaults(Scheme& scm) {
    ...
    std_env->add(
       {  { scm.symbol("#t"),               true },
          ...
          { scm.symbol("with-module"),      Intern::_with_module },
          ...
          { scm.symbol("define-public-macro"),Intern::_macro_public },
          ...
          { scm.symbol("module-name"),        Intern::op_module_name },
          ...
          { scm.symbol("scm-error"),             Intern::op_scm_error },
       });
    // clang-format on
    return std_env;
}
