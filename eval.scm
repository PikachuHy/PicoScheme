...
(define (apply procedre arguments)
  (cond ((primitive-procedure? procedure)
	 (apply-primitive-procedure procedure arguments))
	((compound-procedure? procedure)
	 (extend-enviroment
	  (procedre-paramenters procedure)
	  arguments
	  (procedure-environment procedure)))
	(else
	 (error
	  "Unknown procedure type: APPLE" procedure))))
...
(define (make-procedure paramenters body env)
